import { FaPlay, FaStepForward, FaPause, FaUsers, FaMusic, FaQrcode } from 'react-icons/fa';
import { useState, useEffect } from "react";
import { NavbarAdmin } from "../components/admin/NavbarAdmin";
// import { webPlayBackSDK } from '../services/spotifyWebPlayback.js';
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        <div className="bg-accent-dark text-white p-6 rounded-2xl shadow-xl relative overflow-hidden">
                            <div className="relative z-10">
                                ...
                                <h3 className="text-xl font-bold mt-4 leading-tight">{current_track.name}</h3>
                                ...
                                <div className="mt-6 flex items-center gap-4">
                                    ...
                                    <div className="flex-1 h-1 bg-white/20 rounded-full overflow-hidden">
                                        <div className="h-1 bg-white rounded-full transition-all" style={{ width: `${position}%` }}></div>
                                    </div>
                                </div>
                            </div>
